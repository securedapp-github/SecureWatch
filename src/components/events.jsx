...
function Events() {
  ...
  return (
    <div className='mt-10 mx-2' style={{'backgroundColor':'#FCFFFD'}}>
     <Navbar1/> 
     <div className='w-full mx-auto mt-10 md:mt-20 flex justify-center flex-col md:flex-row md:gap-10 lg:gap-20 '>
     <div className=''>
            <div className='flex'>
...
<path d="M11.5059 18.6469L16.5765 13.5763L11.5059 8.50562" stroke="black" stroke-width="1.69021" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className='mt-5 md:mt-0'>
            ...
            <div className='w-inherit border-2 border-[#B4B4B4] shadow-md p-3 rounded-lg flex px-3 justify-between py-3'>
                <div className='text-[15px] text-[#8E8E8E]'>Type the signature name or select from the dropdown</div>
