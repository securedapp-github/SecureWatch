...
function Monitor_alerts() {
  ...
  return (
    <div className="w-full min-h-full ">
              ...
              <div className=" ">
                ...
                >
                  {explorer[selectedAlert.network]
                    ? `${explorer[selectedAlert.network].replace("/tx/", "/tx/...")}${selectedAlert.hash?.slice(-4)}`
                    : "Unknown"}
                  <FaExternalLinkAlt />
                </a>
              </div>
      ...
      <div className="w-full pb-6 py-6 mx-auto flex justify-center items-center bg-white"> 
