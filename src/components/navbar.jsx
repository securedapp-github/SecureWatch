  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/login">
          <div className="hidden md:block text-white my-auto font-poppin">
            Login
          </div>
        </Link>
        <Link to="/signup">
        ...
        <div
          className="flex md:hidden mx-2 my-auto items-center"
          onClick={() => {
            setOpen(!open);
          }}
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="absolute right-12 w-10 h-10 text-white"
          >
            <path
              strokeLinecap="round"
