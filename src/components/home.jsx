      ...
      <div className="p-8 lg:p-16" style={{ backgroundColor: "#F5F5F4" }}>
        ...
        >
          ...
          <div className="mt-1 text-center">
            <span className="text-[#107F41] text-3xl md:text-5xl font-poppin text-center">
              SecureWatch’s
            </span>
            <span className="text-3xl md:text-5xl font-poppin text-center">
              {" "}
              Real-Time Confidence.
            </span>
          </div>
          <div className="text-[#8F8F8F] mt-10 font-inter text-center">
            Unlock the Future of Transaction Security – Proactive Monitoring,
            &hearts;
          </div>
          <div className="text-[#8F8F8F] font-inter text-center">
        ...
        <div className="text-[#4B5563] mt-4 text-center font-inter">
          Empowering Security, Trust,{" "}
        </div>
        <div className="text-[#4B5563] text-center font-inter">
          Compliance, Growth, and Peace of Mind
        </div>
        <div className="w-full grid grid-cols-1 grid-rows-5 md:grid-cols-2 md:grid-rows-3 md:w-4/6 mx-auto mt-5 font-inter">
          <div
            className="rounded-xl mx-3 p-6"
          ...
          <div
            className="rounded-xl mx-3  p-6 mt-4 md:mt-0"
            style={{ border: "2px solid #E5E5E5" }}
          >
            <img src={c12} alt="" />
            ...
            <div className="font-inter">
              ...
              transactions, providing a secure environment that fosters
              confidence and loyalty.
            </div>
          </div>
          <div
            className="rounded-xl mt-4 mx-3  p-6"
            style={{ border: "2px solid #E5E5E5" }}
          >
            <img src={c13} alt="" />
            <div className="text-3xl font-inter">Peace of Mind</div>
            <div className="font-inter">
              Focus on business growth while SecureWatch takes care of
              transaction security, providing you peace of mind and allowing you
          ...
          >
            ...
            <div className="font-inter">
              ...
              built-in reporting features, facilitating audits and demonstrating
              a commitment to data integrity and compliance.
            </div>
          </div>
          <div
            className="rounded-xl  mt-4 mx-3  p-6"
        ...
        <div className="w-full text-center md:w-1/2 mx-auto text-3xl md:text-5xl mt-14 font-inter">
          Try SecureWatch now, it's free and easy to set up
        </div>
        <div className="w-full mx-auto text-center">
          <Link to="/signup">
            <button className="rounded-full px-4 py-2 text-white mx-auto bg-black my-5 font-inter">
              Sign Up-it's free
            </button>
          </Link>
          <br />
          <span className="p-2 bg-white text-center rounded-md px-6 font-inter">
            Need help or have questions?
          </span>
          <div className="mt-14 flex justify-center flex-wrap">
            <span className="mx-2   font-inter ">Transaction Monitor</span>
