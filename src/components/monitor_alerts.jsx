...
function Monitor_alerts() {
  ...
  if (!alert.alerts || alert.alerts.length === 0 || alert === undefined) {
    return (
      <div className="pt-10 bg-white">
        <Navbar email={email} />
        <div className="text-xl lg:text-3xl font-medium text-black text-center  mt-20">
  ...
  return (
    <div className="pt-10 bg-white pb-10">
      <Navbar email={email} />
      <div className="text-xl lg:text-3xl font-medium text-black text-center mt-10">
        Your Monitor Alerts{" "}
      </div>
                ...
                <div className="w-[95%] lg:w-4/6 mx-auto  flex flex-col mb-14 mt-10">
                  <div className="w-full flex gap-4 flex-wrap">
                    <div className="text-xl font-semibold text-gray-500 bg-[#E9E9E9] px-3 py-2 rounded-xl border-2 border-gray-300">
                      Hash :{" "}
                      <span className="text-lg  text-black ">{`${hash.slice(
                        0,
                        5
                      )}...${hash.slice(hash.length - 4)}`}</span>
                    </div>
                    ...
                    <div className="flex gap-2 items-center text-gray-500 bg-[#E9E9E9] px-3 py-2 rounded-xl border-2 border-gray-300">
                      ...
                      <div className="my-auto text-md font-medium text-black">
                    ...
                    <div className="text-xl font-semibold text-gray-500  bg-[#E9E9E9] px-3 py-2 rounded-xl border-2 border-gray-300">
                      From:{" "}
                      <span className="text-lg mt-auto text-black">{`${from_address.slice(
                        0,
                        5
                      )}...${from_address.slice(
                    ...
                    <div className="text-xl font-semibold  text-gray-500 bg-[#E9E9E9] px-3 py-2 rounded-xl border-2 border-gray-300">
                      To:{" "}
                      <span className="text-lg mt-auto text-black">{`${to_address.slice(
                        0,
                        5
                  ...
                  >
                    <div>
                      <div className="flex gap-3 flex-col">
                        ...
                        <div className="flex gap-6 items-center flex-wrap"></div>
                      </div>
                      ...
                      <div className="flex gap-1 flex-col ">
                        ...
                        <div className=" flex flex-col gap-2">
                          <div className=" text-lg font-semibold text-gray-500 flex gap-1">
                            From:{" "}
                            <span className="text-lg  text-[#7D7D7D] line-clamp-5">
                              {arguemant.slice(9, 51)}
                            </span>
                          </div>
