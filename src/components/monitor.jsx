...
function Monitor() {
  ...
  return (
    <div className='mt-10 mx-2' style={{'backgroundColor':'#FCFFFD'}}>
      ...
      <div className='flex mt-10 justify-between w-3/5 py-3 px-5 rounded-2xl mx-auto md:mx-0' style={{'border':'1px solid #7D7D7D'}}>
...
<circle  cx="2.83594" cy="17.8607" r="2.5" fill="#0CA851"/>
    ...
    <div className='px-2 py-1 rounded-2xl'
     style={{'border':'1px solid #0CA851','display':disp}}>
        <div className='mb-2 cursor-pointer' onClick={openModal}>Save as template</div>
        <hr />
...
<Modal
      ...
      >
       <div className='text-2xl font-medium text-center'>Save First as a template</div>
       <div className='text-[14px] text-[#838383] text-center mt-3'>This will create a template from this monitor. Set a name and description for your template to continue.</div>
       <div className='mt-4 flex flex-col justfiy-center'>
        <div className='text-lg'>Name</div>
        <input type="text" className='px-3 text-base outline-none py-3 rounded-lg' placeholder='Pause Detection template' style={{'border':'1px solid #4C4C4C'}}/>
       </div>
       <div className='mt-3 flex flex-col justfiy-center'>
        <div className='text-lg'>Description</div>
        <input type="text" placeholder='The monitor detects transfer events..' className='px-3 text-base outline-none py-3 rounded-lg'  style={{'border':'1px solid #4C4C4C'}}/>
       </div>
       <div className='text-center'>
       <button className='mt-5 px-5 py-2 text-white bg-[#0CA851] rounded-lg' onClick={closeModal}>Create Template</button>
       </div>
      </Modal>
    </div>
  )
